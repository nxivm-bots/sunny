...
async def update_verify_status(user_id, verify_token="", is_verified=False, verified_time=0, link="", referrer=None, referred=False):
    current = await db_verify_status(user_id)
    
    # Ensure 'referred' key exists in the dictionary
    current.setdefault('referred', False)  # Default to False if 'referred' doesn't exist
    ...
    current['referred'] = referred

    # Save the updated verification status back to the database
